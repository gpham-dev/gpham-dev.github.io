    ...
    <section className="section">
      ...
      <div className="projects">
        ...
        <div className="project">
          ...
          <a href="https://github.h" className="link-button" target="_blank" rel="noopener noreferrer">View on GitHub</a>
        </div>
  ...
  return (
    <section className="section contact-section">
      ...
      <div className="contact-info">
        ...
        <a href="https://www.linkedin.com/in/gierado-pham1/" target="_blank" rel="noopener noreferrer"> 
